...
public class J extends Pieza{
    ...
    public void rotar() {
        if(this.orientacion == 0) {
            ...
            this.ancho = 2;
            this.alto = 3;
            this.anchosDer = new int[] {2,1,1};
            this.anchosIzq = new int[] {0,0,0};
            this.altos = new int[] {3,1};
            this.orientacion = 1;
            ...
            this.anchosIzq = new int[] {0,2};
            this.altos = new int[] {1,1,2};
            this.orientacion = 2;
